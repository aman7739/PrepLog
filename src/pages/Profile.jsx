        ...
        <div className="bg-brand-dark rounded-2xl p-8 mb-6 relative border border-theme-border">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex-1 mt-2 md:mt-0">
              <h1 className="text-2xl font-bold text-theme-text mb-1">{profile.full_name}</h1>
              <p className="text-theme-textSec text-sm mb-3">@{profile.username || userId.substring(0,8)}</p>
